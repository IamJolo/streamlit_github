...
#Definition Session State Variablen
...
#Wenn Antworten überprüfen Button geklickt wird, dann wird die Antwort ausgegeben und der Infotext angezeigt 
...
#Wenn "Antwort überprüfen"-Button geklickt, dann wird die Website nochmal neu geladen, damit die Infotexte und Resultate angezeigt werden
if check_button:
    st.session_state.check_answers = True
    st.rerun()

# Wenn Antwort überprüfen"-Button geklickt und die Seite neu geladen wurde, wird eine Grafik mit den Ergebnissen angezeigt
if st.session_state.check_answers:
    
    #Erzeugung Daten für Chart
